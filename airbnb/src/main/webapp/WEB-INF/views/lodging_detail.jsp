...
<!-- 	<link rel="stylesheet" type="text/css" href="https://cdn.jsdelivr.net/npm/daterangepicker/daterangepicker.css" /> -->
	...
	<meta charset="UTF-8">
	<title><c:out value= '${vo.l_name}' escapeXml="false" /></title>
...
<body>
      <script> 
      	$(function(){
      		if(`${vo.l_state}` == "OFF"){
      			alert("해당 숙소는 운영 중지되었습니다. 메인화면으로 이동합니다.");
      			location.href = "/";
      		}
      		max_people = `${vo.basic_person}`;
      	});
      </script>
	...
	<div class="wrap">
	    <div class="header">
	      ...
	      <div class="content">
	      	<div id="lodging_info" data-value="<c:out value= '${vo.l_id }'/>" class="f_t_2"><c:out value= '${vo.l_name }' escapeXml="false" /></div>
...
<!-- 				      	<div id="reservation_per_info"> -->
							<div id="per_info">
				      			...
				      			<div id="per_info_btn">
					      			<button type="button" class="minus-btn modifyReservationGuest" style="min-width:none;">-</button>
					      			<div data-value="1">게스트 <span id="guset_no">1</span>명</div>
									<button type="button" class="plus-btn modifyReservationGuest">+</button>
			      				</div>
			      			</div>
			      		</div>
			      		<button type="button" class="reservation_btn" onclick="checkLogin(<%= isLogin %>)">예약하기</button>
