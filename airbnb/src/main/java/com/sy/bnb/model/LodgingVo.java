...
//	private List<HashMap<String, String>> theme_list;
	...
	public LodgingVo(String user_email, String l_name, String l_addr, String building_code, String bath_ea,
			String bedroom_ea, String bed_ea, String l_exp, String basic_person, String basic_price,
			List<String> facility_list_string, List<String> theme_list_string) {
		super();
